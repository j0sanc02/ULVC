...
namespace UniversityofLouisvilleVaccine.Controllers
{
    ...
    public class VaccineController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="vaccineID,vaccineName,dateReceived,CPT,ICD9Code,NDC,leadTime,lotNumber,numofDoses,salesPrice,expDate")] Vaccine vaccine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="vaccineID,vaccineName,dateReceived,CPT,ICD9Code,NDC,leadTime,lotNumber,numofDoses,salesPrice,expDate")] Vaccine vaccine)
        {
            if (ModelState.IsValid)
            {
